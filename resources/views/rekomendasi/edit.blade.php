                                ...
                                <div class="col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="number" id="tahun_pemeriksaan" class="form-control"
                                            name="tahun_pemeriksaan" placeholder="Tahun Pemeriksaan" data-parsley-required="true" required value="{{ old('tahun_pemeriksaan', $rekomendasi->tahun_pemeriksaan) }}" min="1900" max="2099" pattern="\d{4}">
