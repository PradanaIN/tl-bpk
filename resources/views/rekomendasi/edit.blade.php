...
@section('section')
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            <div class="row">
                ...
                <div class="card">
                    <form class="form form-vertical" action="/rekomendasi/{{ $rekomendasi->id }}" method="post"
                                    ...
                                    <div id="formContainer">
                                        @foreach ($rekomendasi->tindakLanjut as $index => $tindakLanjut)
                                            ...
                                            <input type="hidden" name="status_tindak_lanjut[]"
                                                value="{{ $tindakLanjut->status_tindak_lanjut }}">
    ...
    <form id="deleteFormTL" action="{{ route('tindaklanjut.destroy', $tindakLanjut->id) }}" method="POST"
        class="d-none">
        @method('DELETE')
        @csrf
    </form>
