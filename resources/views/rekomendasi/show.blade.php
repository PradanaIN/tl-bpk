            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $rekomendasi->pemutakhiran_at !== null && $rekomendasi->pemutakhiran_by !== null ? '' : 'active' }}"
                            id="pemeriksaan-tab" data-bs-toggle="tab" href="#pemeriksaan" role="tab"
                    ...
                    @if ($rekomendasi->pemutakhiran_at !== null && $rekomendasi->pemutakhiran_by !== null)
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $rekomendasi->pemutakhiran_at !== null && $rekomendasi->pemutakhiran_by !== null ? 'active' : '' }}"
                                id="pemutakhiran_status-tab" data-bs-toggle="tab" href="#pemutakhiran_status" role="tab"
                                aria-controls="pemutakhiran_status" aria-selected="false">
        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade {{ $rekomendasi->pemutakhiran_at !== null && $rekomendasi->pemutakhiran_by !== null ? '' : 'show active' }}"
                    ...
                    @if ($rekomendasi->pemutakhiran_at !== null && $rekomendasi->pemutakhiran_by !== null)
                        ...
                        <div class="tab-pane fade {{ $rekomendasi->pemutakhiran_at !== null && $rekomendasi->pemutakhiran_by !== null ? 'show active' : '' }}"
                            id="pemutakhiran_status" role="tabpanel" aria-labelledby="pemutakhiran_status-tab">
                            <div class="card-body">
                                <div class="row custom-row">
                                    <div class="col-lg-2 col-md-3 col-sm-auto" id="judul">
                            ...
                            @if ($rekomendasi->pemutakhiran_at !== null && $rekomendasi->status_rekomendasi === 'Belum Sesuai')
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <p>Rekomendasi yang <strong>Belum Sesuai</strong> akan dilanjutkan di semester
                                        berikutnya.</p>
                                    <hr>
                                    <p class="mb-2">Silakan input kembali <strong>Tindak Lanjut</strong> untuk semester
                                        berikutnya.</p>
                                    <a href="/rekomendasi/{{ $rekomendasi->id }}/nextSemester"
