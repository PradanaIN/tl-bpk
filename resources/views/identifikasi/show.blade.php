        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $tindak_lanjut->status_tindak_lanjut_at === null ? 'active' : '' }}"
                            id="tindaklanjut-tab" data-bs-toggle="tab" href="#tindaklanjut" role="tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ $tindak_lanjut->status_tindak_lanjut_at === null ? '' : 'active' }}"
                            id="identifikasi-tab" data-bs-toggle="tab" href="#identifikasi" role="tab"
                            aria-controls="identifikasi"
                            aria-selected="{{ $tindak_lanjut->status_tindak_lanjut === null || $tindak_lanjut->status_tindak_lanjut === 'Identifikasi' ? 'true' : 'false' }}">
        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade {{ $tindak_lanjut->status_tindak_lanjut_at === null ? 'show active' : '' }}"
                        id="tindaklanjut" role="tabpanel" aria-labelledby="tindaklanjut-tab">
                        <div class="card-body">
                            <div class="row custom-row">
                                <div class="col-lg-2 col-md-3 col-sm-auto" id="judul">
                            ...
                            <div class="row custom-row">
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                    @if ($tindak_lanjut->bukti_tindak_lanjut === null || $tindak_lanjut->bukti_tindak_lanjut === 'Belum Diunggah!')
                                        <p><span
                                                class="status-badge bg-warning text-black">{{ $tindak_lanjut->bukti_tindak_lanjut }}</span>
                                        </p>
                                    @else
                                        <div class="col-auto d-flex ms-auto">
                                            <span
                                                class="status-badge bg-success text-white me-2">{{ $tindak_lanjut->bukti_tindak_lanjut }}</span>
                                            @canany(['Tim Pemantauan Wilayah I', 'Tim Pemantauan Wilayah II', 'Tim
                            ...
                            @if (
                                ...
                                <div class="alert alert-warning mt-3" role="alert">
                                    ...
                                    <p class="mb-0">Bukti tindak lanjut belum diunggah oleh Unit Kerja dan sudah melewati
                                        tenggat waktu!.</p>
                                    <hr>
                                    <p class="mb-0">Idnetifikasi bisa dilakukan dengan memberikan status <strong>Belum
                                            Ditindaklanjuti</strong>.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    <div class="tab-pane fade {{ $tindak_lanjut->status_tindak_lanjut_at === null ? '' : 'show active' }}"
                        id="identifikasi" role="tabpanel" aria-labelledby="identifikasi-tab">
                        @if (
                            $tindak_lanjut->bukti_tindak_lanjut === 'Belum Diunggah!' &&
                                \Carbon\Carbon::now()->lt(\Carbon\Carbon::parse($tindak_lanjut->tenggat_waktu)))
                            <div class="alert alert-warning" role="alert">
                                <h4 class="alert-heading">Peringatan!</h4>
                                <p class="mb-0">Anda belum dapat melakukan identifikasi tindak lanjut karena bukti tindak
                                    lanjut belum diunggah!</p>
                                <hr>
                                <p class="mb-0">Identifikasi dapat dilakukan setelah unit kerja mengunggah bukti tindak
                                    lanjut.</p>
                            </div>
                        @elseif (
                            $tindak_lanjut->bukti_tindak_lanjut === 'Belum Diunggah!' &&
                                ...
                                <div class="row custom-row">
                                    ...
                                    <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                        <div class="col-auto d-flex align-items-center">
                                            <span
                                                class="status-badge {{ getStatusClass($tindak_lanjut->status_tindak_lanjut) }} me-2">{{ $tindak_lanjut->status_tindak_lanjut }}</span>
                                            @if ($rekomendasi->pemutakhiran_at === null && $rekomendasi->pemutakhiran_by === null)
                                                @if ($tindak_lanjut->status_tindak_lanjut_at === null && $tindak_lanjut->status_tindak_lanjut_by === null)
                                                    <button class="btn btn-primary" id="uploadBtn"
                                                        ...
                                                        title="Tambah Hasil Identifikasi">
                ...
                <div class="modal-body">
                    ...
                    @if (
                        ...
                        <div class="form-group mandatory">
                            ...
                            <select class="form-select" name="status_tindak_lanjut" id="status_tindak_lanjut"
                                required>
                                <option value="Belum Ditindaklanjuti"
                                    {{ $tindak_lanjut->status_tindak_lanjut === 'Belum Ditindaklanjuti' ? 'selected' : '' }}>
                    ...
                    @else
                        <div class="form-group mandatory">
                            ...
                            <select class="form-select" name="status_tindak_lanjut" id="status_tindak_lanjut"
                                required>
                                <option value="Sesuai"
                                    {{ $tindak_lanjut->status_tindak_lanjut === 'Sesuai' ? 'selected' : '' }}>Sesuai
                                </option>
                                <option value="Belum Sesuai"
                                    {{ $tindak_lanjut->status_tindak_lanjut === 'Belum Sesuai' ? 'selected' : '' }}>
                                    Belum Sesuai</option>
                                <option value="Belum Ditindaklanjuti"
                                    {{ $tindak_lanjut->status_tindak_lanjut === 'Belum Ditindaklanjuti' ? 'selected' : '' }}>
                                    Belum Ditindaklanjuti</option>
                                <option value="Tidak Ditindaklanjuti"
                                    {{ $tindak_lanjut->status_tindak_lanjut === 'Tidak Ditindaklanjuti' ? 'selected' : '' }}>
