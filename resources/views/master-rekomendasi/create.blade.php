...
<section id="basic-vertical-layouts">
    <div class="row match-height">
        <div class="row">
            ...
            <div class="card">
                <form class="form form-vertical" action="/master-rekomendasi" method="post" data-parsley-validate id="formTambahRekomendasi" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="rekomendasi" role="tabpanel" aria-labelledby="rekomendasi-tab">
                                ...
                                <div class="col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="date" class="form-control flatpickr-no-config" name="semester_rekomendasi" placeholder="Semester Rekomendasi" value="{{ old('semester_rekomendasi') }}">
                            ...
                            <div class="tab-pane fade" id="lhp" role="tabpanel" aria-labelledby="lhp-tab">
                                <div class="form-group mandatory">
                                    ...
                                    <input type="file" class="basic-filepond" name="lhp" id="lhp_input" required>
                                    @error('lhp')
                            ...
                            <div class="tab-pane fade" id="bukti_input_siptl" role="tabpanel" aria-labelledby="bukti_input_siptl-tab">
                                ...
                                <div class="form-group mandatory">
                                    ...
                                    name="detail_bukti_input_siptl" id="detail_bukti_input_siptl" placeholder="Detail Bukti Input SIPTL" data-parsley-required="true" required>{{ old('detail_bukti_input_siptl') }}</textarea>
