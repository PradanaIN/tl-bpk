            ...
            <div class="table-responsive">
                <table class="table" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr class='clickable-row' data-href="/master-rekomendasi/{{ $rekomendasi->id }}}}">
                            ...
                            <td>
                                <div class="d-flex justify-content-around align-items-center">
                                    <a href="/master-rekomendasi/{{ $rekomendasi->id }}" class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Detail Rekomendasi">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </div>
                            </td>
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            window.location.href = '/master-rekomendasi/create';
                        }
                    }
                ]
            });
