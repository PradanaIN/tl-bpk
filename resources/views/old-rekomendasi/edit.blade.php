...
@section('section')
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="bukti_input_siptl-tab" data-bs-toggle="tab"
                                    href="#bukti_input_siptl" role="tab" aria-controls="bukti_input_siptl"
                                    aria-selected="false">
                                    <h6>Bukti Input SIPTL</h6>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pemutakhiran_status-tab" data-bs-toggle="tab"
                ...
                <div class="card">
                    <form class="form form-vertical" action="/old-rekomendasi/{{ $rekomendasi->id }}" method="post"
                        data-parsley-validate id="formTambahRekomendasi" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" id="pemeriksaan" class="form-control" name="pemeriksaan"
                                                ...
                                                value="{{ old('pemeriksaan', $rekomendasi->pemeriksaan) }}">
                                            @error('pemeriksaan')
                                            ...
                                            <select class="form-select" id="jenis_pemeriksaan" name="jenis_pemeriksaan"
                                                ...
                                                @foreach ($kamus_pemeriksaan as $kamus)
                                                    <option value="{{ $kamus->nama }}"
                                                        {{ $kamus->nama == $rekomendasi->jenis_pemeriksaan ? 'selected' : '' }}>
                                                        {{ $kamus->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="tab-pane fade" id="rekomendasi" role="tabpanel"
                                        ...
                                        <div class="form-group mandatory">
                                            ...
                                            <select class="form-select" id="jenis_temuan" name="jenis_temuan"
                                                ...
                                                @foreach ($kamus_temuan as $kamus)
                                                    <option value="{{ $kamus->nama }}"
                                                        {{ $kamus->nama == $rekomendasi->jenis_temuan ? 'selected' : '' }}>
                                                        {{ $kamus->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <textarea class="form-control" id="uraian_temuan" rows="3" name="uraian_temuan" placeholder="Uraian Temuan"
                                                data-parsley-required="true" required>{{ old('uraian_temuan', $rekomendasi->uraian_temuan) }}</textarea>
                                            @error('uraian_temuan')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <textarea class="form-control" id="rekomendasi" class="form-control" name="rekomendasi" placeholder="Rekomendasi"
                                                data-parsley-required="true" required rows="3">{{ old('rekomendasi', $rekomendasi->rekomendasi) }}</textarea>
                                            @error('rekomendasi')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <textarea class="form-control" id="catatan_rekomendasi" rows="3" name="catatan_rekomendasi"
                                                placeholder="Catatan Rekomendasi" data-parsley-required="true" required>{{ old('catatan_rekomendasi', $rekomendasi->catatan_rekomendasi) }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            <label class="form-label" for="semester_rekomendasi">Semester
                                                Rekomendasi</label>
                                            <input type="date" class="form-control flatpickr-no-config"
                                                name="semester_rekomendasi" placeholder="Semester Rekomendasi"
                                                value="{{ old('semester_rekomendasi', $rekomendasi->semester_rekomendasi) }}">
                                ...
                                <div class="tab-pane fade" id="lhp" role="tabpanel" aria-labelledby="lhp-tab">
                                    <div class="alert alert-warning" role="alert">
                                        ...
                                        <p>Jika dokumen Laporan Hasil Pemeriksaan (LHP) tidak mengalami perubahan, tidak
                                            perlu mengunggah ulang.</p>
                                        <hr>
                                        <p class="mb-0">Dokumen LHP yang terakhir diunggah:
                                            <strong>{{ $rekomendasi->lhp }}</strong></p>
                                    </div>
                                    <input type="hidden" name="lhp_lama" value="{{ $rekomendasi->lhp }}">
                                    <div class="form-group mandatory">
                                            ...
                                            <div class="form-repeater mb-4">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-4 mb-3 form-group mandatory">
                                                        <label class="form-label" for="unit_kerja{{ $index }}">PIC
                                                            Unit Kerja</label>
                                                        <select class="form-select select-unit-kerja" name="unit_kerja[]"
                                                            id="unit_kerja{{ $index }}">
                                                            <option value="{{ $tindakLanjut->unit_kerja }}">
                                                                {{ $tindakLanjut->unit_kerja }}</option>
                                                            @foreach ($unit_kerja as $unit)
                                                                <option value="{{ $unit->nama }}">{{ $unit->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-4 mb-3 form-group mandatory">
                                                        <label class="form-label"
                                                            for="tim_pemantauan{{ $index }}">PIC Tim
                                                            Pemantauan</label>
                                                        <select class="form-select select-tim-pemantauan"
                                                            name="tim_pemantauan[]">
                                                            <option value="{{ $tindakLanjut->tim_pemantauan }}">
                                                                {{ $tindakLanjut->tim_pemantauan }}</option>
                                                            <option value="Tim Pemantauan Wilayah I">Tim Pemantauan Wilayah
                                                                I</option>
                                                            <option value="Tim Pemantauan Wilayah II">Tim Pemantauan
                                                                Wilayah II</option>
                                                            <option value="Tim Pemantauan Wilayah III">Tim Pemantauan
                                                                Wilayah III</option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-4 mb-3 form-group mandatory">
                                                        <label class="form-label"
                                                            for="tenggat_waktu{{ $index }}">Tenggat Waktu</label>
                                                        <input type="date" class="form-control flatpickr-no-config"
                                                            name="tenggat_waktu[]" placeholder="Tenggat Waktu"
                                                            value="{{ $tindakLanjut->tenggat_waktu }}">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6 mb-3 form-group mandatory">
                                                        <input type="hidden" name="bukti_tindak_lanjut[]"
                                                            value="{{ $tindakLanjut->bukti_tindak_lanjut }}">
                                                        <label class="form-label"
                                                            for="bukti_tindak_lanjut{{ $index }}">Bukti Tindak
                                                            Lanjut</label>
                                                        <input type="file" class="form-control"
                                                            name="bukti_tindak_lanjut[]"
                                                            id="bukti_tindak_lanjut{{ $index }}"
                                                            accept=".pdf,.zip,.rar">
                                                        @error('bukti_tindak_lanjut.' . $index)
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                        @if (!$tindakLanjut->wasRecentlyCreated)
                                                            <div class="text-muted mt-2">Riwayat file terakhir: <a
                                                                    href="{{ asset($tindakLanjut->bukti_tindak_lanjut) }}"
                                                                    target="_blank">{{ $tindakLanjut->bukti_tindak_lanjut }}</a>
                                                            </div>
                                                        @endif
                                                        <div class="text-muted mt-2">* Jika tidak mengubah file, tidak
                                                            perlu mengunggah kembali.</div>
                                                    </div>
                                                    <div class="col-md-6 mb-3 form-group mandatory">
                                                        <label class="form-label"
                                                            for="status_tindak_lanjut{{ $index }}">Status Tindak
                                                            Lanjut</label>
                                                        <select class="form-select" name="status_tindak_lanjut[]">
                                                            <option value="">Pilih Status Tindak Lanjut</option>
                                                            <option value="Sesuai"
                                                                {{ old('status_tindak_lanjut.' . $index, $tindakLanjut->status_tindak_lanjut) == 'Sesuai' ? 'selected' : '' }}>
                                                                Sesuai</option>
                                                            <option value="Belum Sesuai"
                                                                {{ old('status_tindak_lanjut.' . $index, $tindakLanjut->status_tindak_lanjut) == 'Belum Sesuai' ? 'selected' : '' }}>
                                                                Belum Sesuai</option>
                                                            <option value="Belum Ditindaklanjuti"
                                                                {{ old('status_tindak_lanjut.' . $index, $tindakLanjut->status_tindak_lanjut) == 'Belum Ditindaklanjuti' ? 'selected' : '' }}>
                                                                Belum Ditindaklanjuti</option>
                                                            <option value="Tidak Ditindaklanjuti"
                                                                {{ old('status_tindak_lanjut.' . $index, $tindakLanjut->status_tindak_lanjut) == 'Tidak Ditindaklanjuti' ? 'selected' : '' }}>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-12 form-group mandatory">
                                                        <label class="form-label"
                                                            for="detail_bukti_tindak_lanjut{{ $index }}">Detail
                                                            Bukti Tindak Lanjut</label>
                                                        <textarea class="form-control" rows="3" name="detail_bukti_tindak_lanjut[]"
                                                            id="detail_bukti_tindak_lanjut{{ $index }}" placeholder="Detail Bukti Tindak Lanjut">{{ old('detail_bukti_tindak_lanjut.' . $index, $tindakLanjut->detail_bukti_tindak_lanjut) }}</textarea>
                                ...
                                <div class="tab-pane fade" id="bukti_input_siptl" role="tabpanel"
                                    ...
                                    <div class="alert alert-warning" role="alert">
                                        <h4 class="alert-heading">Info!</h4>
                                        <p>Jika dokumen Bukti Input SIPTL tidak mengalami perubahan, tidak perlu mengunggah
                                            ulang.</p>
                                        <hr>
                                        <p class="mb-0">Dokumen Bukti Input SIPTL yang terakhir diunggah:
                                            <strong>{{ $rekomendasi->buktiInputSIPTL->bukti_input_siptl }}</strong></p>
                                    </div>
                                    <div class="form-group mandatory">
                                        <label for="bukti_input_siptl" class="form-label">Bukti Input SIPTL</label>
                                        <input type="file" class="form-control" name="bukti_input_siptl"
                                            id="bukti_input_siptl_input" required accept=".pdf,.png,.jpg">
                                    ...
                                    <div class="form-group mandatory">
                                        <label for="detail_bukti_input_siptl" class="form-label">Detail Bukti Input
                                            SIPTL</label>
                                        <textarea class="form-control" rows="3" name="detail_bukti_input_siptl" id="detail_bukti_input_siptl"
                                            placeholder="Detail Bukti Input SIPTL" data-parsley-required="true" required>{{ old('detail_bukti_input_siptl', $rekomendasi->buktiInputSIPTL->detail_bukti_input_siptl) }}</textarea>
                                ...
                                <div class="tab-pane fade" id="pemutakhiran_status" role="tabpanel"
                                    ...
                                    <div class="form-group mandatory">
                                        ...
                                        <select class="form-select" name="status_rekomendasi" id="status_rekomendasi"
                                            required>
                                            <option value="Sesuai"
                                                {{ $rekomendasi->status_rekomendasi === 'Sesuai' ? 'selected' : '' }}>
                                                Sesuai</option>
                                            <option value="Belum Sesuai"
                                                {{ $rekomendasi->status_rekomendasi === 'Belum Sesuai' ? 'selected' : '' }}>
                                                Belum Sesuai</option>
                                            <option value="Belum Ditindaklanjuti"
                                    ...
                                    <div class="form-group mandatory" id="catatan_pemutakhiran_group"
                                        style="display: none;">
    ...
    <form id="deleteFormTL" action="{{ route('oldtindaklanjut.destroy', $tindakLanjut->id) }}" method="POST"
        class="d-none">
        @method('DELETE')
        @csrf
    </form>
    ...
    <script>
        ...
        document.querySelectorAll('.nav-link').forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                (); // Jika tab "Tindak Lanjut" aktif, tampilkan tombol "Back" dan "Next"
                } else if (this.getAttribute('aria-controls') === 'bukti_input_siptl') {
                    showBuktiInputSIPTLActions
                (); // Jika tab "Bukti Input SIPTL" aktif, tampilkan tombol "Back" dan "Next"
                } else if (this.getAttribute('aria-controls') === 'pemutakhiran_status') {
                    showPemutakhiranStatusActions
                (); // Jika tab "Pemutakhiran Status" aktif, tampilkan tombol "Back" saja
                }
            });
        });
    </script>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        document.getElementById('deleteFormTL').setAttribute('action',
                            '/old-tindak-lanjut/' + id);
                        // Submit form delete
