    ...
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            <div class="row">
                ...
                <div class="card">
                    <form class="form form-vertical" action="/old-rekomendasi" method="post" data-parsley-validate
                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="number" id="tahun_pemeriksaan" class="form-control"
                                                ...
                                                value="{{ old('tahun_pemeriksaan') }}" min="1900" max="2099"
                                                pattern="\d{4}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <textarea class="form-control" id="hasil_pemeriksaan" rows="3" name="hasil_pemeriksaan"
                                                placeholder="Hasil Pemeriksaan" data-parsley-required="true" required>{{ old('hasil_pemeriksaan') }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="date" class="form-control flatpickr-no-config"
                                                ...
                                                value="{{ old('semester_rekomendasi') }}">
                                ...
                                <div class="tab-pane fade" id="lhp" role="tabpanel" aria-labelledby="lhp-tab">
                                    <div class="form-group mandatory">
                                        <label for="lhp" class="form-label">Dokumen Laporan Hasil Pemeriksaan
                                            (LHP)</label>
                                        <input type="file" class="basic-filepond" name="lhp" id="lhp_input"
                                            required>
                                        @error('lhp')
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <button type="button" class="btn btn-primary btn-tambah-repeater">
                                                <i class="bi bi-plus"></i><span class="d-none d-md-inline">&nbsp;Tambah
                                                    Tindak Lanjut</span>
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-repeater mb-4">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6 mb-3 form-group mandatory">
                                                    <label class="form-label" for="bukti_tindak_lanjut">Bukti Tindak
                                                        Lanjut</label>
                                                    <input type="file" class="form-control"
                                                        name="bukti_tindak_lanjut[]" required accept=".pdf,.zip,.rar">
                                                    @error('bukti_tindak_lanjut.0')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3 form-group mandatory">
                                                    <label class="form-label" for="status_tindak_lanjut">Status Tindak
                                                        Lanjut</label>
                                                    <select class="form-select" name="status_tindak_lanjut[]">
                                                        <option value="">Pilih Status Tindak Lanjut</option>
                                                        <option value="Sesuai"
                                                            {{ old('status_tindak_lanjut.0') == 'Sesuai' ? 'selected' : '' }}>
                                                            Sesuai</option>
                                                        <option value="Belum Sesuai"
                                                            {{ old('status_tindak_lanjut.0') == 'Belum Sesuai' ? 'selected' : '' }}>
                                                            Belum Sesuai</option>
                                                        <option value="Belum Ditindaklanjuti"
                                                            {{ old('status_tindak_lanjut.0') == 'Belum Ditindaklanjuti' ? 'selected' : '' }}>
                                                            Belum Ditindaklanjuti</option>
                                                        <option value="Tidak Ditindaklanjuti"
                                                            {{ old('status_tindak_lanjut.0') == 'Tidak Ditindaklanjuti' ? 'selected' : '' }}>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12 form-group mandatory">
                                                    <label class="form-label" for="detail_bukti_tindak_lanjut">Detail
                                                        Bukti Tindak Lanjut</label>
                                                    <textarea class="form-control" rows="3" name="detail_bukti_tindak_lanjut[]"
                                                        placeholder="Detail Bukti Tindak Lanjut">{{ old('detail_bukti_tindak_lanjut.0') }}</textarea>
                                ...
                                <div class="tab-pane fade" id="bukti_input_siptl" role="tabpanel"
                                    ...
                                    <div class="form-group mandatory">
                                        ...
                                        <textarea class="form-control" rows="3" name="detail_bukti_input_siptl" id="detail_bukti_input_siptl"
                                            placeholder="Detail Bukti Input SIPTL" data-parsley-required="true" required>{{ old('detail_bukti_input_siptl') }}</textarea>
                                ...
                                <div class="tab-pane fade" id="pemutakhiran_status" role="tabpanel"
                                    ...
                                    <div class="form-group mandatory" id="catatan_pemutakhiran_group"
                                        ...
                                        <textarea class="form-control" name="catatan_pemutakhiran" id="catatan_pemutakhiran" rows="3" required>{{ old('catatan_pemutakhiran', $rekomendasi->catatan_pemutakhiran ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <!-- filepond js untuk bukti input siptl -->
    {{-- <script>
    function initializeFilePondSIPTL() {
        FilePond.registerPlugin(
            FilePondPluginFileValidateSize,
            FilePondPluginFileValidateType,
            FilePondPluginImageCrop,
        ...
        FilePond.create(document.getElementById('bukti_input_siptl_input'));
    }

    document.addEventListener('DOMContentLoaded', initializeFilePondSIPTL);
</script> --}}
    <!-- pop catatan -->
    <script>
