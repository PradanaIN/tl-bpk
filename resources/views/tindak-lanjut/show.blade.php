        ...
        <div class="row mb-3 flex-wrap">
            ...
            <div class="col-auto d-flex ms-auto">
                <div class="col-auto">
                    ...
                    @else
                        <button class="btn btn-outline-success" id="btnStatusBukti" data-bs-toggle="tooltip"
                            data-bs-placement="bottom"
                            title="{{ \Carbon\Carbon::parse($tindak_lanjut->upload_at)->translatedFormat('H:i, d M Y') }}">
                            <i class="bi bi-check-square"></i>
                            <span class="d-none d-md-inline">&nbsp;Bukti Diunggah
                                {{ \Carbon\Carbon::parse($tindak_lanjut->upload_at)->diffForHumans() }}</span>
                        </button>
                    @endif
                    ...
                    @else
                        <button class="btn btn-outline-success" id="btnStatusIdentifikasi" data-bs-toggle="tooltip"
                            data-bs-placement="bottom"
                            title="{{ \Carbon\Carbon::parse($tindak_lanjut->status_tindak_lanjut_at)->translatedFormat('H:i, d M Y') }}">
                            <i class="bi bi-check-square"></i>
                            <span class="d-none d-md-inline">&nbsp;Diidentifikasi
                                {{ \Carbon\Carbon::parse($tindak_lanjut->status_tindak_lanjut_at)->diffForHumans() }}</span>
                        </button>
                    @endif
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="tindaklanjut-tab" data-bs-toggle="tab" href="#tindaklanjut"
                    ...
                    @if ($tindak_lanjut->status_tindak_lanjut !== 'Proses')
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="identifikasi-tab" data-bs-toggle="tab" href="#identifikasi"
                                role="tab" aria-controls="identifikasi" aria-selected="false">
                                <h6>Hasil Identifikasi</h6>
                            </a>
                        </li>
                    @endif
                </ul>
        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="tindaklanjut" role="tabpanel"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row custom-row">
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                    @if (
                                        $tindak_lanjut->bukti_tindak_lanjut === null ||
                                            $tindak_lanjut->bukti_tindak_lanjut === 'Belum Diunggah!' ||
                                            $tindak_lanjut->bukti_tindak_lanjut === '')
                                        <div class="col-auto d-flex align-items-center">
                                            <span
                                                class="status-badge bg-warning text-black me-2">{{ $tindak_lanjut->bukti_tindak_lanjut }}</span>
                                            @canany(['Operator Unit Kerja', 'Super Admin'])
                                                @if (\Carbon\Carbon::now()->lt(\Carbon\Carbon::parse($tindak_lanjut->tenggat_waktu)))
                                                    <button class="btn btn-primary" id="uploadBtn" data-bs-toggle="tooltip"
                                                        data-bs-placement="bottom" title="Unggah Bukti TL">
                                    ...
                                    @else
                                        <div class="col-auto d-flex ms-auto">
                                            <span
                                                class="status-badge bg-success text-white me-2">{{ $tindak_lanjut->bukti_tindak_lanjut }}</span>
                                            @canany(['Operator Unit Kerja', 'Super Admin'])
                            ...
                            @if (
                                \Carbon\Carbon::now()->gt(\Carbon\Carbon::parse($tindak_lanjut->tenggat_waktu)) &&
                                    $tindak_lanjut->bukti_tindak_lanjut === 'Belum Diunggah!')
                                @php
                                ...
                                @if (Auth::user()->hasRole('Operator Unit Kerja'))
                                    <div class="alert alert-warning mt-3" role="alert">
                                        ...
                                        <p>&nbsp;Waktu terakhir untuk mengunggah adalah:
                                            <strong>{{ $waktuUpload }}.</strong></p>
                                        <hr>
                                        <p class="mb-0"><strong>Silakan hubungi Inspektorat Utama untuk mendapatkan
                                                informasi lebih lanjut.</strong></p>
                                    </div>
                                @else
                                    <div class="alert alert-warning mt-3" role="alert">
                            ...
                            @elseif (
                                ...
                                <div class="row custom-row">
                                    ...
                                    <div class="col-auto d-none d-md-block" id="limiter">:</div>
                                    <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                        <p>{{ strip_tags(html_entity_decode($tindak_lanjut->detail_bukti_tindak_lanjut)) }}
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-auto d-none d-md-block" id="limiter">:</div>
                                    <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                        <p>Diunggah oleh {{ $tindak_lanjut->upload_by }} pada
                                            {{ \Carbon\Carbon::parse($tindak_lanjut->upload_at)->translatedFormat('d M Y') }}
                                        </p>
                                    </div>
                                </div>
                            @endif
                    ...
                    <div class="tab-pane fade" id="identifikasi" role="tabpanel" aria-labelledby="identifikasi-tab">
                        @if (
                            \Carbon\Carbon::now()->lt(\Carbon\Carbon::parse($tindak_lanjut->tenggat_waktu)) &&
                                $tindak_lanjut->bukti_tindak_lanjut === 'Belum Diunggah!')
                            <div class="alert alert-warning" role="alert">
                                <h4 class="alert-heading">Peringatan!</h4>
                                <p>Anda belum dapat melihat hasil identifikasi karena bukti tindak lanjut belum diunggah.
                                </p>
                                <hr>
                            ...
                            <div class="card-body">
                                ...
                                @if ($tindak_lanjut->catatan_tindak_lanjut !== '' && $tindak_lanjut->catatan_tindak_lanjut !== null)
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-auto d-none d-md-block" id="limiter">:</div>
                                        <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                            <p>{{ strip_tags(html_entity_decode($tindak_lanjut->catatan_tindak_lanjut)) }}
                                            </p>
                                        </div>
                                    </div>
                                @endif
                                @if ($tindak_lanjut->status_tindak_lanjut_at !== null)
                                    <div class="row">
                                        ...
                                        <div class="col-auto d-none d-md-block" id="limiter">:</div>
                                        <div class="col-lg-8 col-md-9 col-sm-12" id="text">
                                            <p>Diidentifikasi oleh {{ $tindak_lanjut->status_tindak_lanjut_by }} pada
                                                {{ \Carbon\Carbon::parse($tindak_lanjut->status_tindak_lanjut_at)->translatedFormat('d M Y') }}
                                            </p>
                                        </div>
                                    </div>
                                @else
                                    <div class="alert alert-warning mt-3" role="alert">
                                        <p>Tindak lanjut telah melewati batas waktu dan sedang dalam proses identifikasi
                                            oleh {{ $tindak_lanjut->tim_pemantauan }}.</p>
                                        <hr>
                                        <p class="mb-0">Silakan tunggu hasil identifikasi oleh
                                            {{ $tindak_lanjut->tim_pemantauan }}.</p>
                                    </div>
                                @endif
                            </div>
                        @else
                            <div class="card-body">
                                ...
                                @else
                                    <div class="alert alert-warning mt-3" role="alert">
                                        <p>Bukti tindak lanjut sedang dalam proses identifikasi oleh
                                            {{ $tindak_lanjut->tim_pemantauan }}.</p>
                                        <hr>
                                        <p class="mb-0">Silakan tunggu hasil identifikasi oleh
                                            {{ $tindak_lanjut->tim_pemantauan }}.</p>
...
<div class="modal fade text-left" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel"
    aria-hidden="true">
            ...
            <form action="/tindak-lanjut/{{ $tindak_lanjut->id }}" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group mandatory">
                        <label for="bukti_tindak_lanjut" class="form-label">Bukti Tindak Lanjut
                            (.pdf/.zip/.rar/.tar)</label>
                    ...
                    <div class="form-group mandatory">
                        ...
                        <div class="card-body">
                            <textarea class="form-control" name="detail_bukti_tindak_lanjut" id="detail_bukti_tindak_lanjut" rows="3"
                                required data-parsley-required="true">{{ old('detail_bukti_tindak_lanjut', $tindak_lanjut->detail_bukti_tindak_lanjut ?? '') }}</textarea>
...
<div class="modal fade" id="ubahTenggatWaktuModal" tabindex="-1" aria-labelledby="ubahTenggatWaktuModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/tindak-lanjut/{{ $tindak_lanjut->id }}/updateDeadline" method="post"
                ...
                <div class="modal-body">
                    ...
                    <div class="col-auto form-group mandatory">
                        ...
                        <input type="date" class="form-control flatpickr-no-config" name="tenggat_waktu"
                            placeholder="Tenggat Waktu" value="{{ old('tenggat_waktu') }}">
                        @error('tenggat_waktu')
...
@section('script')
    ...
    <script>
        ...
        FilePond.setOptions({
            ...
            fileValidateTypeLabelExpectedTypes: 'Hanya menerima file PDF, ZIP, dan RAR',
