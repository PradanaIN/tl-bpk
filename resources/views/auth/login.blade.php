			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url({{ asset('mazer/assets/auth/images/bg-login.jpg') }});"></div>
						<div class="login-wrap p-4 p-md-5">
							<div class="d-flex">
								<div class="w-100 me-auto d-flex justify-content-center align-items-center">
                                    <img class="mb-3" src="{{ asset('mazer/assets/static/images/logo/logo-bps.png') }}" alt="Logo" style="width: 50px; height: auto;">
							...
							<form action="/auth/login" method="post" class="signin-form">
								...
								<div class="form-group mb-3">
									...
									<input type="text" class="form-control @error('email') is-invalid @enderror" value="@error('email'){{ old('email') }}@else{{ old('email') }}@enderror" name="email" placeholder="Email" required>
                                    @error('email')
