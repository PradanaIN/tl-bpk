        ...
        <div class="row">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="/kelola-pengguna/{{ $user->id }}" method="post">
                            @method('put')
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    name="nama" placeholder="Nama" value="{{ old('nama', $user->nama) }}">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="password-vertical" class="form-control"
                                                    name="password" placeholder="Password" value="{{ old('password', $user->nama) }}">
                                            </div>
                                        </div>
